...
- **Blameless 원칙**: 특정 사람/에이전트의 실수가 아니라 설계·프로세스의 gap으로 서술한다. "누가 실수했는가"가 아니라 "무엇이 이 실수를 가능하게 했는가"를 기록해야 재발을 막을 수 있다 (근거: [00-control-tower/external-reference-survey.md](../00-control-tower/external-reference-survey.md#인시던트-대응-문서-관행)).
